...
class PsychCredits extends ScriptedMusicBeatState
{
    ...
    var defaultList:Array<Array<String>> = [
        ...
        ["Dokibird Public Squad", "dps", "Silly Fancord by Dragoons and Bark Knights", "https://twitter.com/dokibirdsquad"],
        ["Special Shoutouts"],
	...
	override function update(elapsed:Float)
    {
        ...
        if(controls.ACCEPT) 
        {
            if(creditsStuff[curSelected][1] == 'afeefflox') //Kagami Asmr lol
                openSubState(ScriptedMusicBeatSubState.init('StickerSubState', 'kagami'));
